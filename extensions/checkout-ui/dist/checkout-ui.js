...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const lotMerge = (0, import_react11.useMemo)(() => {
      var _a;
      return (_a = attributes.find((attr) => attr.key === "_LotMerge")) == null ? void 0 : _a.value;
    }, [attributes]);
    const isLotMode = true;
    let [hasCompleted, setHasCompleted] = (0, import_react11.useState)(false);
    if (!isLotMode) {
      return null;
    }
    (0, import_react11.useEffect)(() => {
      Promise.all(
        lines.map(
          (line) => line.lineComponents.length > 0 ? applyCartLinesChange({
            type: "updateCartLine",
            id: line.id,
    ...
    (0, import_react11.useEffect)(() => {
      if (lotMerge === void 0 || lotMerge === "undefined" && hasCompleted) {
    ...
    }, [lotMerge === void 0 || lotMerge === "undefined" && hasCompleted]);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked: lotMerge === "yes", onChange: onCheckboxChange, children: "Combine multiple items into one" });
